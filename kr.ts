export const KR = {
    ...
    CristoRedentorDesc: "문화를 소비하고 모든 건물에 인접한 보너스를 제공합니다",
    Istanbul: "이스탄불",
    Wormhole: "웜홀",
    WavesSurvived: "웨이브에서 살아남은 숫자",
    NumberOfWormholes: "지도내 생성된 웜홀 갯수",
    NextWave: "다음 웨이브",
    NextWaveUnitHP: "유닛 체력",
    NextWaveTotalCount: "모든 유닛",
    NextWaveTotalCountDesc: "각 웜홀에서 생성되는 유닛 갯수",
    NextWaveSpeed: "이동 속도",
    NextWaveSpawnDelay: "Spawn Frequency",
    NextWaveSpawnDelayValue: "Every %{number}s",
    NextWaveBonusMultiplier: "보너스 승수",
    NextWaveBonusMultiplierValue: "%{number}x",
    NextWaveTotalDamageNeeded: "총합 데미지 필요량",
    NextWaveTotalReward: "보상 목록",
    StartWave: "단계 시작",
    WaveSpawned: "생성됨",
